      ...
      >
        <div className="p-6">
                  ...
                  <li key={section.id}>
                    <button
                      ...
                      className={`w-full flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition-all duration-200 ${
                        isActive
                          ? 'bg-[#4988C4]/20 text-[#4988C4] border-l-2 border-[#4988C4]'
          ...
          <div className="mt-8 pt-6 border-t border-[#1F1F1F]">
            <Link
              to="/browse"
              className="flex items-center gap-2 text-sm text-[#4988C4] hover:text-[#1C4D8D] transition-colors"
            >
      ...
      <main className="ml-64 min-h-screen">
        <div ref={sectionsRef} className="max-w-4xl mx-auto px-8 py-12">
          ...
          <section id="introduction" className="mb-16 scroll-mt-8">
            <div className="bg-[#4988C4]/10 backdrop-blur-md rounded-2xl p-8">
              ...
              <div className="space-y-8">
                ...
                <div>
                  <div className="flex items-center gap-2 mb-4">
                    <h2 className="text-xl font-semibold text-[#4988C4]">Problems for Founders</h2>
                  </div>
                ...
                <div>
                  <div className="flex items-center gap-2 mb-4">
                    <h2 className="text-xl font-semibold text-[#4988C4]">Problems for Investors</h2>
                  </div>
                  <div className="space-y-4">
                    <div className="p-4 rounded-xl bg-[#1A1A1A] border border-[#2A2A2A]">
              ...
              <div className="space-y-6">
                <div className="p-4 rounded-xl bg-[#1A1A1A] border border-[#2A2A2A]">
                  ...
                  <div className="p-4 rounded-xl bg-[#0A0A0A]">
                    <p className="text-sm font-mono text-[#F6F6F6]/60">
                      <span className="text-[#4988C4]">Network:</span> Arbitrum Sepolia<br />
                      <span className="text-[#4988C4]">Chain ID:</span> 421614<br />
                      <span className="text-[#4988C4]">RPC:</span> https://arbitrum-sepolia.drpc.org
                    </p>
                  </div>
                </div>
                ...
                <div className="p-4 rounded-xl bg-[#1A1A1A] border border-[#2A2A2A]">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div className="p-3 rounded-xl bg-[#4988C4]/10 border border-[#4988C4]/20">
                      <p className="font-medium text-[#4988C4]">Founder</p>
                      <p className="text-sm text-[#F6F6F6]/40">Create funding rounds</p>
                    </div>
                    <div className="p-3 rounded-xl bg-[#4988C4]/10 border border-[#4988C4]/20">
                      <p className="font-medium text-[#4988C4]">Investor</p>
                ...
                <div className="p-4 rounded-xl bg-[#1A1A1A] border border-[#2A2A2A]">
                  ...
                  <p className="text-sm text-[#4988C4]">Airdrop: 1,000 USDC (one-time)</p>
                </div>
              </div>
            </div>
          </section>
          ...
          <section id="fundamentals" className="mb-16 scroll-mt-8">
            <div className="bg-[#4988C4]/10 backdrop-blur-md rounded-2xl p-8">
              ...
              <div className="space-y-8">
                <div>
                  <h2 className="text-xl font-semibold mb-4 text-[#4988C4]">How Yield Generation Works</h2>
                  <div className="p-6 rounded-xl bg-[#1A1A1A] border border-[#2A2A2A]">
                    <div className="grid grid-cols-3 gap-4 text-center mb-6">
                      <div>
                        <p className="text-2xl font-bold text-[#1C4D8D]">$100K</p>
                        <p className="text-sm text-[#F6F6F6]/40">Investment</p>
                      </div>
                      <div>
                        <p className="text-2xl font-bold text-[#1C4D8D]">6% APY</p>
                        <p className="text-sm text-[#F6F6F6]/40">Yield Rate</p>
                      </div>
                      <div>
                        <p className="text-2xl font-bold text-[#1C4D8D]">$500/mo</p>
                ...
                <div>
                  <h2 className="text-xl font-semibold mb-4 text-[#4988C4]">Tokenized Equity</h2>
                  <p className="text-[#F6F6F6]/60 mb-4">
                    ...
                    <table className="w-full text-sm">
                      <thead>
                        <tr className="border-b border-[#2A2A2A]">
                          ...
                          <th className="text-left p-3 font-semibold text-[#4988C4]">fndr Tokens</th>
                        </tr>
                      </thead>
                      <tbody className="text-[#F6F6F6]/60">
                        <tr className="border-b border-[#1F1F1F]">
                          <td className="p-3">Paper certificates</td>
                          <td className="p-3 text-[#4988C4]">ERC-20 tokens</td>
                        </tr>
                        <tr className="border-b border-[#1F1F1F]">
                          <td className="p-3">Hard to transfer</td>
                          <td className="p-3 text-[#4988C4]">Tradeable after 180 days</td>
                        </tr>
                        <tr className="border-b border-[#1F1F1F]">
                          <td className="p-3">No yield</td>
                          <td className="p-3 text-[#4988C4]">6% APY from day one</td>
                        </tr>
                        <tr>
                          <td className="p-3">Company records</td>
                          <td className="p-3 text-[#4988C4]">Blockchain verified</td>
                        </tr>
                      </tbody>
                    </table>
                  </div>
                ...
                <div>
                  <h2 className="text-xl font-semibold mb-4 text-[#4988C4]">Investment Lifecycle</h2>
                  <div className="space-y-4">
                    {[
                      ...
                      <div key={step.num} className="flex items-start gap-4">
                        <div className="w-8 h-8 rounded-full bg-[#4988C4] flex items-center justify-center flex-shrink-0 text-sm font-bold text-black">
                          {step.num}
                        </div>
                        <div>
          ...
          <section id="for-founders" className="mb-16 scroll-mt-8">
            <div className="bg-[#4988C4]/10 backdrop-blur-md rounded-2xl p-8">
              ...
              <div className="space-y-8">
                ...
                <div>
                  <h2 className="text-xl font-semibold mb-4 text-[#4988C4]">How fndr Solves Your Problems</h2>
                  <div className="space-y-4">
                    <div className="p-4 rounded-xl bg-[#1A1A1A] border border-[#2A2A2A]">
                    ...
                    <div className="p-4 rounded-xl bg-[#1A1A1A] border border-[#2A2A2A]">
                      ...
                      <p className="text-[#F6F6F6]/60">
                        Just <strong className="text-[#4988C4]">10 USDC</strong> to create a round + <strong className="text-[#4988C4]">0.5%</strong> success fee. Smart contracts handle cap table, compliance, and distributions automatically.
                      </p>
                    </div>
                    <div className="p-4 rounded-xl bg-[#1A1A1A] border border-[#2A2A2A]">
                    ...
                    <div className="p-4 rounded-xl bg-[#1A1A1A] border border-[#2A2A2A]">
                      ...
                      <p className="text-[#F6F6F6]/60">
                        Your raised capital earns <strong className="text-[#4988C4]">6% APY</strong> in the vault. You receive 50% of yield monthly - additional runway without diluting equity.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                {/* How to Create Round */}
                <div>
                  <h2 className="text-xl font-semibold mb-4 text-[#4988C4]">Creating a Funding Round</h2>
                  <div className="p-4 rounded-xl bg-[#1A1A1A] border border-[#2A2A2A]">
                ...
                {/* Withdrawals */}
                <div>
                  <h2 className="text-xl font-semibold mb-4 text-[#4988C4]">Withdrawing Funds</h2>
                  <div className="p-4 rounded-xl bg-[#1A1A1A] border border-[#2A2A2A]">
                    <p className="text-[#F6F6F6]/60">
                ...
                {/* Fees */}
                <div>
                  <h2 className="text-xl font-semibold mb-4 text-[#4988C4]">Platform Fees</h2>
                  <div className="grid grid-cols-2 gap-4">
                    <div className="p-4 rounded-xl bg-[#1A1A1A] border border-[#2A2A2A]">
                      <p className="text-2xl font-bold text-[#4988C4]">10 USDC</p>
                      <p className="text-sm text-[#F6F6F6]/40">Round Creation</p>
                    </div>
                    <div className="p-4 rounded-xl bg-[#1A1A1A] border border-[#2A2A2A]">
                      <p className="text-2xl font-bold text-[#4988C4]">0.5%</p>
          ...
          <section id="for-investors" className="mb-16 scroll-mt-8">
            <div className="bg-[#4988C4]/10 backdrop-blur-md rounded-2xl p-8">
              ...
              <div className="space-y-8">
                ...
                {/* How to Invest */}
                <div>
                  <h2 className="text-xl font-semibold mb-4 text-[#4988C4]">How to Invest</h2>
                  <ol className="space-y-4">
                    {[
                      ...
                      <li key={i} className="flex items-start gap-4">
                        <span className="w-6 h-6 rounded-full bg-[#4988C4] flex items-center justify-center flex-shrink-0 text-xs font-bold text-black">
                          {i + 1}
                        </span>
                        <div>
                ...
                <div>
                  <h2 className="text-xl font-semibold mb-4 text-[#4988C4]">Your Returns</h2>
                  <div className="grid grid-cols-2 gap-4">
                    <div className="p-4 rounded-xl bg-[#4988C4]/10 border border-[#4988C4]/20">
                      <h3 className="font-semibold text-[#4988C4] mb-2">Yield Returns</h3>
                      <p className="text-sm text-[#F6F6F6]/60">
                        3% APY (your 50% share)
                ...
                <div>
                  <h2 className="text-xl font-semibold mb-4 text-[#4988C4]">Secondary Trading</h2>
                  <div className="p-4 rounded-xl bg-[#1A1A1A] border border-[#2A2A2A]">
          ...
          <section id="technical" className="mb-16 scroll-mt-8">
            <div className="bg-[#4988C4]/10 backdrop-blur-md rounded-2xl p-8">
              <div className="flex items-center gap-3 mb-6">
                <h1 className="text-3xl font-bold text-[#4988C4]">Technical Architecture</h1>
              </div>

              <div className="space-y-8">
                <div>
                  <h2 className="text-xl font-semibold mb-4 text-[#4988C4]">System Overview</h2>
...
RainbowKit              AI/LLM                 Foundry`}</pre>
                ...
                <div>
                  <h2 className="text-xl font-semibold mb-4 text-[#4988C4]">Tech Stack</h2>
                  <div className="grid grid-cols-2 gap-3">
                    {[
                      ...
                      <div key={item.layer} className="p-3 rounded-xl bg-[#1A1A1A] border border-[#2A2A2A]">
                        <p className="font-medium text-[#4988C4] text-sm">{item.layer}</p>
          ...
          <section id="smart-contracts" className="mb-16 scroll-mt-8">
            <div className="bg-[#4988C4]/10 backdrop-blur-md rounded-2xl p-8">
              ...
              <div className="space-y-6">
                <div>
                  <h2 className="text-xl font-semibold mb-4 text-[#4988C4]">Contract Addresses</h2>
                  <div className="space-y-3">
                    {[
                      ...
                      <div key={contract.name} className="p-4 rounded-xl bg-[#1A1A1A] border border-[#2A2A2A]">
                        ...
                        <code className="text-xs text-[#4988C4] break-all">{contract.address}</code>
                      </div>
                    ))}
                  </div>
                </div>
                ...
                <div>
                  <h2 className="text-xl font-semibold mb-4 text-[#4988C4]">Contract Flow</h2>
                  <div className="p-4 rounded-xl bg-[#0A0A0A] font-mono text-sm overflow-x-auto">
...
SecondaryMarket → trades → StartupEquityToken`}</pre>
          ...
          <section id="zk-identity" className="mb-16 scroll-mt-8">
            <div className="bg-[#4988C4]/10 backdrop-blur-md rounded-2xl p-8">
              ...
              <div className="space-y-8">
                <div>
                  <h2 className="text-xl font-semibold mb-4 text-[#4988C4]">What is ZK-Passport?</h2>
                  <div className="p-4 rounded-xl bg-[#1A1A1A] border border-[#2A2A2A]">
                    <p className="text-[#F6F6F6]/60 mb-4">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div className="p-3 rounded-xl bg-[#0A0A0A]">
                        <p className="font-medium text-[#4988C4]">What's Proven</p>
                ...
                <div>
                  <h2 className="text-xl font-semibold mb-4 text-[#4988C4]">Why ZK Proofs Matter</h2>
                  <div className="space-y-3">
                    {[
                ...
                <div>
                  <h2 className="text-xl font-semibold mb-4 text-[#4988C4]">ZK Circuits (Built)</h2>
                  <div className="grid grid-cols-2 gap-3">
                    {[
          ...
          <section id="security" className="mb-16 scroll-mt-8">
            <div className="bg-[#4988C4]/10 backdrop-blur-md rounded-2xl p-8">
              ...
              <div className="space-y-8">
                <div>
                  <h2 className="text-xl font-semibold mb-4 text-[#4988C4]">Investor Protections</h2>
                  <div className="space-y-3">
                    <div className="p-4 rounded-xl bg-[#1A1A1A] border border-[#2A2A2A]">
                ...
                <div>
                  <h2 className="text-xl font-semibold mb-4 text-[#4988C4]">Risk Warnings</h2>
                  <div className="p-4 rounded-xl bg-[#1A1A1A] border border-[#2A2A2A]">
          ...
          <div className="border-t border-[#1F1F1F] pt-8 mt-16">
            <div className="flex items-center justify-between">
              ...
              <Link
                to="/browse"
                className="flex items-center gap-2 px-4 py-2 bg-[#4988C4] text-black font-semibold rounded-xl hover:bg-[#1C4D8D] transition-colors text-sm"
              >
                Launch App
                <ArrowUpRight className="h-4 w-4" />
              </Link>
