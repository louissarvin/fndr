          ...
          <section id="introduction" className="mb-16 scroll-mt-8">
            <div className="bg-[#A2D5C6]/10 backdrop-blur-md rounded-2xl p-8">
              ...
              <p className="text-lg text-[#F6F6F6]/60 mb-8">
                Welcome to <strong className="text-white">fndr</strong>, the decentralized startup fundraising platform built on Lisk blockchain that transforms how startups raise capital and how investors grow their wealth.
              </p>
                ...
                <div className="p-4 rounded-xl bg-[#1A1A1A] border border-[#2A2A2A]">
                  ...
                  <div className="p-4 rounded-xl bg-[#0A0A0A]">
                    <p className="text-sm font-mono text-[#F6F6F6]/60">
                      <span className="text-[#A2D5C6]">Network:</span> Lisk Sepolia<br />
                      <span className="text-[#A2D5C6]">Chain ID:</span> 4202<br />
                      <span className="text-[#A2D5C6]">RPC:</span> https://lisk-sepolia.drpc.org
                    </p>
                  </div>
                </div>
              ...
              <div className="space-y-8">
                <div>
                  ...
                  <div className="p-4 rounded-xl bg-[#0A0A0A] font-mono text-sm overflow-x-auto">
                    <pre className="text-[#F6F6F6]/60">{`Frontend (React)  →  Backend (Ponder)  →  Blockchain (Lisk)
      │                      │                      │
